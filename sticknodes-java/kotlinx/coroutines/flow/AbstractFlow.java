...
public abstract class AbstractFlow<T> implements kotlinx.coroutines.flow.Flow<T> {

    /* compiled from: Flow.kt */
    @kotlin.coroutines.jvm.internal.DebugMetadata(c = "kotlinx.coroutines.flow.AbstractFlow", f = "Flow.kt", l = {230}, m = "collect")
