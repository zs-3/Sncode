...
public class SmartStretchInstructionsDialog extends org.fortheloss.sticknodes.animationscreen.dialogs.DialogWrapper {
    private com.badlogic.gdx.graphics.Texture mTexture1;

    public SmartStretchInstructionsDialog(org.fortheloss.sticknodes.animationscreen.AnimationScreen r1) {
            r0 = this;
            r0.<init>(r1)
            return
    }
    ...
    public void initialize(org.fortheloss.framework.Assets r4) {
            ...
            java.lang.String r2 = org.fortheloss.sticknodes.App.smartStretchInstructionsTexture
