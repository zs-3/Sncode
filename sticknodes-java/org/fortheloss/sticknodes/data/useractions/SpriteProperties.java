...
public class SpriteProperties implements com.badlogic.gdx.utils.Disposable {
    public float angle;
    public float blur;
    ...
    public float sSCalcDefaultAngleFromNode;
    public float sSCalcDefaultHeight;
    public float sSCalcDefaultWidth;
    public float sSCalcNegativeDiff;
    public float sSRememberedAngle;
    public float sSRememberedNodeAngle;
    public float sSRememberedNodeLength;
    public float sSRememberedScale;
    public float sSRememberedStickfigureScale;
    public float saturation;
    public boolean scaleLinked;
    public float scaleX;
    public float scaleXYRatio;
    public float scaleY;
    public int smartStretchState;
    public int stateIndex;
    public boolean stateIsControlled;
    ...
    public SpriteProperties(org.fortheloss.sticknodes.sprite.SpriteRef r6) {
            r5 = this;
            r5.<init>()
            r0 = 0
            r5.x = r0
            ...
            r5.smartStretchState = r4
            r5.stateIsControlled = r2
            r5.stateIndex = r2
    ...
    public void getProperties(org.fortheloss.sticknodes.sprite.SpriteRef r1) {
            r0 = this;
            r1.getProperties(r0)
            return
    }
