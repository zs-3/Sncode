...
public class ObstacleTCB extends org.fortheloss.sticknodes.minigamescreen.obstacles.Obstacle {
    public ObstacleTCB(org.fortheloss.framework.Assets r1, org.fortheloss.sticknodes.minigamescreen.MiniGameScreen r2, float r3, float r4, float r5) {
            r0 = this;
    ...
    public void draw(com.badlogic.gdx.graphics.g2d.Batch r7, float r8) {
            ...
            com.badlogic.gdx.graphics.g2d.TextureRegion r0 = r6._trCobbleStoneTR
            float r1 = r6.getX()
            float r2 = r6.getY()
