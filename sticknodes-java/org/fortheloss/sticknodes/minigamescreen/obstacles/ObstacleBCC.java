...
public class ObstacleBCC extends org.fortheloss.sticknodes.minigamescreen.obstacles.Obstacle {
    public ObstacleBCC(org.fortheloss.framework.Assets r1, org.fortheloss.sticknodes.minigamescreen.MiniGameScreen r2, float r3, float r4, float r5) {
            r0 = this;
    ...
    public void draw(com.badlogic.gdx.graphics.g2d.Batch r13, float r14) {
            ...
            float r5 = r1.b
            float r6 = r1.a
            float r7 = r12._buildingFade
            r8 = 1065353216(0x3f800000, float:1.0)
            float r7 = r8 - r7
            float r6 = r6 * r7
            r13.setColor(r3, r4, r5, r6)
            com.badlogic.gdx.graphics.g2d.TextureRegion r3 = r12._trCobbleStoneTR
            float r4 = r12.getX()
            float r5 = r12.getY()
