...
public class TextButtonLongPress extends com.badlogic.gdx.scenes.scene2d.ui.TextButton {
    ...
    public static class TextButtonLongPressStyle extends com.badlogic.gdx.scenes.scene2d.ui.TextButton.TextButtonStyle {
        ...
        public TextButtonLongPressStyle(com.badlogic.gdx.scenes.scene2d.ui.TextButton.TextButtonStyle r1, com.badlogic.gdx.scenes.scene2d.utils.Drawable r2) {
                r0 = this;
                r0.<init>(r1)
                r0.indicator = r2
                return
    ...
    public TextButtonLongPress(java.lang.String r1, org.fortheloss.sticknodes.TextButtonLongPress.TextButtonLongPressStyle r2) {
            r0 = this;
            r0.<init>(r1, r2)
            r1 = 0
            r0._pressSeconds = r1
    ...
    public void act(float r4) {
            ...
            float r1 = org.fortheloss.sticknodes.TextButtonLongPress.longPressSeconds
    ...
    public void draw(com.badlogic.gdx.graphics.g2d.Batch r11, float r12) {
            ...
            com.badlogic.gdx.scenes.scene2d.ui.TextButton$TextButtonStyle r3 = r10.getStyle()
            if (r1 == 0) goto L20
            if (r0 != 0) goto L20
        ...
        L2d:
            com.badlogic.gdx.scenes.scene2d.ui.TextButton$TextButtonStyle r2 = r10.getStyle()
            org.fortheloss.sticknodes.TextButtonLongPress$TextButtonLongPressStyle r2 = (org.fortheloss.sticknodes.TextButtonLongPress.TextButtonLongPressStyle) r2
    ...
    public void setLongPressEnabled(boolean r1) {
            r0 = this;
            r0._longPressEnabled = r1
            if (r1 != 0) goto L7
            r0.stopPressCount()
