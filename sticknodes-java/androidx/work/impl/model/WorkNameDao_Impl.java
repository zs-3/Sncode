...
public final class WorkNameDao_Impl implements androidx.work.impl.model.WorkNameDao {
    ...
    public WorkNameDao_Impl(androidx.room.RoomDatabase r2) {
            r1 = this;
            r1.<init>()
            r1.__db = r2
            androidx.work.impl.model.WorkNameDao_Impl$1 r0 = new androidx.work.impl.model.WorkNameDao_Impl$1
            r0.<init>(r1, r2)
            r1.__insertionAdapterOfWorkName = r0
            return
    }

    @Override // androidx.work.impl.model.WorkNameDao
    public java.util.List<java.lang.String> getNamesForWorkSpecId(java.lang.String r5) {
            r4 = this;
            java.lang.String r0 = "SELECT name FROM workname WHERE work_spec_id=?"
            r1 = 1
    ...
    @Override // androidx.work.impl.model.WorkNameDao
    public void insert(androidx.work.impl.model.WorkName r2) {
            r1 = this;
            androidx.room.RoomDatabase r0 = r1.__db
            r0.assertNotSuspendingTransaction()
            androidx.room.RoomDatabase r0 = r1.__db
            r0.beginTransaction()
            androidx.room.EntityInsertionAdapter<androidx.work.impl.model.WorkName> r0 = r1.__insertionAdapterOfWorkName     // Catch: java.lang.Throwable -> L1a
