...
public class BatteryChargingController extends androidx.work.impl.constraints.controllers.ConstraintController<java.lang.Boolean> {
    public BatteryChargingController(android.content.Context r1, androidx.work.impl.utils.taskexecutor.TaskExecutor r2) {
            r0 = this;
            androidx.work.impl.constraints.trackers.Trackers r1 = androidx.work.impl.constraints.trackers.Trackers.getInstance(r1, r2)
            androidx.work.impl.constraints.trackers.BatteryChargingTracker r1 = r1.getBatteryChargingTracker()
            r0.<init>(r1)
            return
    }
    ...
    boolean hasConstraint(androidx.work.impl.model.WorkSpec r1) {
            ...
            boolean r1 = r1.requiresCharging()
            return r1
    }
