...
public class NetworkNotRoamingController extends androidx.work.impl.constraints.controllers.ConstraintController<androidx.work.impl.constraints.NetworkState> {
    ...
    static {
            ...
            androidx.work.impl.constraints.controllers.NetworkNotRoamingController.TAG = r0
            return
    }

    public NetworkNotRoamingController(android.content.Context r1, androidx.work.impl.utils.taskexecutor.TaskExecutor r2) {
            r0 = this;
    ...
    boolean isConstrained2(androidx.work.impl.constraints.NetworkState r6) {
            ...
            java.lang.String r3 = androidx.work.impl.constraints.controllers.NetworkNotRoamingController.TAG
