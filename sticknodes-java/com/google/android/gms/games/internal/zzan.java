...
final class zzan extends com.google.android.gms.games.internal.zza {
    private final com.google.android.gms.tasks.TaskCompletionSource zza;

    zzan(com.google.android.gms.tasks.TaskCompletionSource r1) {
            r0 = this;
            r0.<init>()
            r0.zza = r1
            return
    ...
    public final void zzh(com.google.android.gms.common.data.DataHolder r7) {
            r6 = this;
        ...
        La:
            ...
            return
        L13:
            com.google.android.gms.games.GameBuffer r2 = new com.google.android.gms.games.GameBuffer
            r2.<init>(r7)
            r7 = 1
            r3 = 0
            int r4 = r2.getCount()     // Catch: java.lang.Throwable -> L3d
            if (r4 <= 0) goto L2a
            com.google.android.gms.games.Game r4 = r2.get(r3)     // Catch: java.lang.Throwable -> L3d
            com.google.android.gms.games.GameEntity r5 = new com.google.android.gms.games.GameEntity     // Catch: java.lang.Throwable -> L3d
