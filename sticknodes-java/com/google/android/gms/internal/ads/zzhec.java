...
final class zzhec extends com.google.android.gms.internal.ads.zzhee {
    zzhec(sun.misc.Unsafe r1) {
            r0 = this;
            r0.<init>(r1)
            return
    }
    ...
    public final byte zza(long r1) {
            r0 = this;
            int r2 = (int) r1
            byte r1 = libcore.io.Memory.peekByte(r2)
            return r1
    }
    ...
    public final void zzd(long r1, byte[] r3, long r4, long r6) {
            ...
            int r4 = (int) r6
            int r2 = (int) r1
            libcore.io.Memory.peekByteArray(r2, r3, r5, r4)
            return
    }
