...
final class zzbyy implements java.util.concurrent.ThreadFactory {
    private final java.util.concurrent.atomic.AtomicInteger zza;

    zzbyy(com.google.android.gms.internal.ads.zzbyz r2) {
            r1 = this;
            r1.<init>()
    ...
    public final java.lang.Thread newThread(java.lang.Runnable r5) {
            ...
            r2.<init>()
            java.lang.String r3 = "AdWorker(SCION_TASK_EXECUTOR) #"
            r2.append(r3)
            r2.append(r0)
