...
public class zbb extends android.os.Binder implements android.os.IInterface {
    protected zbb(java.lang.String r1) {
            r0 = this;
            r0.<init>()
    ...
    public final boolean onTransact(int r2, android.os.Parcel r3, android.os.Parcel r4, int r5) throws android.os.RemoteException {
        ...
        L14:
            boolean r2 = r1.zba(r2, r3, r4, r5)
            return r2
    }

    protected boolean zba(int r1, android.os.Parcel r2, android.os.Parcel r3, int r4) throws android.os.RemoteException {
            r0 = this;
            r1 = 0
            throw r1
    }
