...
public class VertexBufferObject implements com.badlogic.gdx.graphics.glutils.VertexData {
    ...
    public VertexBufferObject(boolean r3, int r4, com.badlogic.gdx.graphics.VertexAttributes r5) {
            r2 = this;
            r2.<init>()
            r0 = 0
            r2.isDirty = r0
            ...
            int r1 = r1.glGenBuffer()
            r2.bufferHandle = r1
            int r1 = r5.vertexSize
            int r1 = r1 * r4
            java.nio.ByteBuffer r4 = com.badlogic.gdx.utils.BufferUtils.newUnsafeByteBuffer(r1)
            r4.limit(r0)
            r0 = 1
            r2.setBuffer(r4, r0, r5)
            if (r3 == 0) goto L25
    ...
    protected void setBuffer(java.nio.Buffer r2, boolean r3, com.badlogic.gdx.graphics.VertexAttributes r4) {
            r1 = this;
            boolean r0 = r1.isBound
            if (r0 != 0) goto L45
            boolean r0 = r1.ownsBuffer
            if (r0 == 0) goto Lf
        ...
        Lf:
            r1.attributes = r4
            boolean r4 = r2 instanceof java.nio.ByteBuffer
            if (r4 == 0) goto L3d
            ...
            java.nio.ByteBuffer r3 = r1.byteBuffer
            r3.limit(r2)
            java.nio.FloatBuffer r3 = r1.buffer
            int r2 = r2 / 4
            r3.limit(r2)
            return
        L3d:
            com.badlogic.gdx.utils.GdxRuntimeException r2 = new com.badlogic.gdx.utils.GdxRuntimeException
            java.lang.String r3 = "Only ByteBuffer is currently supported"
            r2.<init>(r3)
            throw r2
        L45:
            com.badlogic.gdx.utils.GdxRuntimeException r2 = new com.badlogic.gdx.utils.GdxRuntimeException
            java.lang.String r3 = "Cannot change attributes while VBO is bound"
            r2.<init>(r3)
            throw r2
    }

    protected void setUsage(int r2) {
            r1 = this;
            boolean r0 = r1.isBound
            if (r0 != 0) goto L7
            r1.usage = r2
        ...
        L7:
            com.badlogic.gdx.utils.GdxRuntimeException r2 = new com.badlogic.gdx.utils.GdxRuntimeException
            java.lang.String r0 = "Cannot change usage while VBO is bound"
            r2.<init>(r0)
            throw r2
    }
